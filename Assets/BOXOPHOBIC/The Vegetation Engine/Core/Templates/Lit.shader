	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Workflow:Specular,Metallic,BlinnPhong,Lambert:Metallic
				...
				Specular:HidePort:Spec
				Specular:HidePort:Gloss
				...
				Metallic:HidePort:Spec
				Metallic:HidePort:Gloss
				...
				BlinnPhong:HidePort:Specular
				BlinnPhong:ShowPort:Spec
				BlinnPhong:ShowPort:Gloss
				...
				Lambert:HidePort:Spec
				Lambert:HidePort:Gloss
		...
		*/
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				#if defined(ASE_LIGHTING_SIMPLE)
					o.Specular = /*ase_frag_out:Spec;Float3;20;-1;_Spec*/fixed3( 0, 0, 0 )/*end*/;
					o.Gloss = /*ase_frag_out:Gloss;Float;21;-1;_Gloss*/0/*end*/;
				#else
					#if defined(_SPECULAR_SETUP)
